/**
* @name JKGameActivityToggle
 * @version 1.0.0
 * @description Be able to enable/disable game activity
 * @author JikaiSH
 ...
 * @updateUrl https://raw.githubusercontent.com/JikaiSH/betterdiscordplugins/main/JKGameActivityToggle.plugin.js
 */
...
module.exports = (() => {
  const config = {
     info: {
        ...
        authors: [
           {
              name: 'JikaiSH',
              discord_id: '847526008651382814',
              github_username: 'JikaiSH'
           }
        ],
        version: '1.0.0',
        description: 'In status selector you can enable or disable game activity.',
        github: 'https://github.com/JkaiSH',
        github_raw: 'https://raw.githubusercontent.com/JikaiSH/betterdiscordplugins/main/JKGameActivityToggle.plugin.js'
     },
     changelog: [
        {
           type: 'added',
           title: 'New JikaiSH plugin wow !',
           items: [
              'Plugin work !'
           ]
        }
  ...
  return !global.ZeresPluginLibrary ? class {
     ...
     getDescription() {
        return config.info.description + ' You are missing libraries for this plugin, please enable the plugin and click Download for the plugin work.';
     }
           ...
           Patcher.before(Menu, 'default', (_, args) => {
              ...
              if (!children.find(c => c?.props?.id == 'game-activity')) {
                 children.splice(children.indexOf(invisibleStatus) + 1, 0, React.createElement(Menu.MenuItem, {
                    ...
                    }, 'Show currently running game as a "playing" status message.'))
                 }));
              }
           });
        };
